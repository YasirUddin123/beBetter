...
//       <p>History:</p>
//       <p class="response">Here is the table header </p>
//       <p>
//         {results.map(result => {
//             return (
//                 <p class="response">{result.physical_activity} {result.diet} {result.sleep} {result.mood} {result.comments} <button onClick={() => handleEditbtn(result.id)}>EDIT</button> <button onClick={() =>handleDeletebtn(result.id)}>DELETE</button>
//                 </p>
//             )
//         })}
//       </p>
